...
wget -c http://upload.wikimedia.org/wikipedia/en/7/75/Qt-logo.svg
convert Qt-logo.svg -resize 859x1024 Qt-logo-859x1024.png
convert Qt-logo-859x1024.png -background transparent -gravity center -extent 1024x1024 Qt-logo-1024x1024.png

wget -c http://upload.wikimedia.org/wikipedia/commons/c/c2/F_icon.svg -O Facebook-logo.svg
convert Facebook-logo.svg -resize 384x384 Facebook-logo-384x384.png
